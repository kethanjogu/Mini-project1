...
<body>
    <nav class="navbar">
                ...
                <div class="navbar-center">
                    <ul>
                        <li><a href="mini project/index.php" class="active-link"><img src="images/home.png" alt=""><span>Home</span></a></li>
    ...
    <div class="content-wrapper">
        ...
        <div class="theme-image">
            <img src="music.png" alt="Artistic Representation">
        </div>
    </div>
    ...
    <footer>
        <p>Copyright © 2021 Art Paintings Gallery</p>
    </footer>
